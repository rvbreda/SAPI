...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        echo $this->Html->css('grid/960.min');
        ...
        echo $this->Html->script('http://jzaefferer.github.com/jquery-validation/jquery.validate.js');
        ...
        <div class="container_12">
            <div class="grid_2 btn-group top20 bottom20">
                ...
                <ul class="dropdown-menu">
                    <li class="prop_pendentes"><?php echo $this->Html->link('Propostas Pendentes', array('controller' => 'proposals', 'action' => 'pending_proposals')) ?></li>
                </ul>
            </div>
            ...
            <div class="grid_2 btn-group top20 bottom20">
                ...
                <ul class="dropdown-menu">
                    <li class="prop_pendentes"><?php echo $this->Html->link('Projetos Pendentes', array('controller' => 'projects', 'action' => 'pending_projects')) ?></li>
                </ul>
            </div>
