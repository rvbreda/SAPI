        ...
        <div class="container_12">
            <div class="grid_2 btn-group top20 bottom20">
                ...
                <ul class="dropdown-menu">
                    <li class="prop_adicionar"><?php echo $this->Html->link('Submeter', array('controller' => 'proposals', 'action' => 'add')) ?></li>
                    <li class="prop_submetidas"><?php echo $this->Html->link('Propostas Submetidas', array('controller' => 'proposals', 'action' => 'index')) ?></li>
<!--                    <li><a href="#">...</a></li>-->
                </ul>
            </div>
